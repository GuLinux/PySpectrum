...
class PlotsMath(QWidget):
    ...
    def __init__(self, settings, database):
        ...
        self.save_result = self.toolbar.addAction(QIcon(':/save_20'), 'Save', lambda: QtCommons.save_file_sticky('Save Operation Result...', 'FITS file (.fit)', self.save, self.settings, MATH_OPERATION_DIR, [CALIBRATED_PROFILE_DIR]))
