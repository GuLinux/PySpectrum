...
class ProjectDialog(QDialog):
    def __init__(self, settings, project = None):
        ...
        self.ui.observer.setText(self.project.get_observer() if project else settings.value('observer'))
        self.ui.position.setText(self.project.get_position() if project else settings.value('position'))
        self.ui.equipment.setText(self.project.get_equipment() if project else settings.value('equipment'))
