...
class Ui_SelectPlottedPoints(object):
    def setupUi(self, SelectPlottedPoints):
        ...
        self.smoothing_degree.setProperty("value", 3)
        self.smoothing_degree.setSliderPosition(3)
        ...
        self.smoothing_factor_auto.setChecked(True)
        ...
        self.smoothing_factor.setEnabled(False)
