...
# Form implementation generated from reading ui file 'ui/line_edit.ui'
#
...
class Ui_LineEdit(object):
    def setupUi(self, LineEdit):
        ...
        LineEdit.resize(394, 187)
        self.gridLayout = QtWidgets.QGridLayout(LineEdit)
        self.gridLayout.setObjectName("gridLayout")
        self.label = QtWidgets.QLabel(LineEdit)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 0, 0, 1, 1)
        self.line_text_wrapper = QtWidgets.QWidget(LineEdit)
        self.line_text_wrapper.setObjectName("line_text_wrapper")
        self.gridLayout.addWidget(self.line_text_wrapper, 0, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.show_lambda, 2, 1, 1, 2)
