...
# Form implementation generated from reading ui file 'ui/select_plotted_point.ui'
#
...
class Ui_SelectPlottedPoints(object):
    def setupUi(self, SelectPlottedPoints):
        ...
        self.smoothing_degree.setProperty("value", 4)
        self.smoothing_degree.setSliderPosition(4)
        ...
        self.smoothing_factor_auto.setChecked(False)
