...
class Ui_HomePage(object):
    def setupUi(self, HomePage):
        ...
        self.recent_projects = QtWidgets.QTableView(HomePage)
        self.recent_projects.setEnabled(False)
        self.recent_projects.setObjectName("recent_projects")
        self.gridLayout.addWidget(self.recent_projects, 2, 2, 1, 1)
        ...
        self.open_project = QtWidgets.QPushButton(HomePage)
        ...
        self.gridLayout.addWidget(self.download_catalogs, 4, 1, 1, 1)
    ...
    def retranslateUi(self, HomePage):
        ...
        self.label.setText(_translate("HomePage", "Recent Projects"))
